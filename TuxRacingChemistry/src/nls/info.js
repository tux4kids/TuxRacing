...
define({
    root: {
        name: "Chemistry (Demo)",
        description: "Demonstration of a static test-bank",

        // This shouldn't need to be replaced by translations
        refName: "chemdem"
    },
    defaultLocale: 'en'
    // If other locales are included here, all appropriate lesson translations must be available
    // "fr-fr": true
});