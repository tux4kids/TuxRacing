...
(function () {
    ...
    //>>excludeStart('excludeI18n', pragmas.excludeI18n)
    ...
    //>>excludeEnd('excludeI18n')

    function detectLocale(navigator) {
        var isAndroid = navigator.userAgent && navigator.userAgent.match(/Android/),
            locale;
                    ...
                    if (!locale) {
                        locale = masterConfig.locale =
                            typeof navigator === "undefined" ? "root" :
                                (detectLocale(navigator) || "root").toLowerCase();
                    }
                    parts = locale.split("-");
                }
