...
// It should be up to the mobile
    ...
    MBP.fastButton.prototype.reset = function(event) {
        var element = event.srcElement;
        rmEvt(element, "touchend", this.handleEvent.bind(this), false);
        rmEvt(document.body, "touchmove", this.handleEvent.bind(this), false);
        element.style.backgroundColor = "";
    };

    MBP.fastButton.prototype.addClickEvent = function(element) {
        addEvt(element, "touchstart", this.handleEvent.bind(this), false);
        addEvt(element, "click", this.handleEvent.bind(this), false);
    };
